...
let audioCtx = null;
let lastRenderTimestamp = 0; // Guard anti-duplicados al reconectar WebSocket
...
function renderTasks() {
    ...
    if (previousAssignedIds !== null) {
        ...
        // Guard: solo alertar si pasaron al menos 2s desde el último render
        // Evita alertas falsas por reconexión del WebSocket que re-dispara todos los datos
        if (newOrders.length > 0 && (now - lastRenderTimestamp) > 2000) {
